...
static const int64 DUST_SOFT_LIMIT = 100000000; // 1 IEP
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000000;   // 0.01 IEP mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 3726516578 * COIN; // Maximum or compile warning, will fix in future release. 
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 2700 / 250;
    }
